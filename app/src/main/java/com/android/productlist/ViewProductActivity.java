...
public class ViewProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product_SV = findViewById(R.id.sv_provprod);
        product_RV = findViewById(R.id.rv_provprod);
        parentView = findViewById(R.id.cl_pviewparent);
        ...
        if(product_uid.size()>0) {
            ...
            product_RV.setAdapter(productAda);
            ...
            ItemTouchHelper.SimpleCallback itscproduct = new ItemTouchHelper.SimpleCallback(0,
                ...
                public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                    ...
                    Snackbar.make(parentView,"Product Deleted: "+prodname,5000).setAction("UNDO", new View.OnClickListener() {
                        @Override
            ...
            ithprod.attachToRecyclerView(product_RV); // attaching itemtouchhelper to recyclerview
